...
FDM.ADOQueryVvodNagruzki.Open;
ShowMessage('Нагрузка добавлена')
end;
...
FDM.ADOQueryVvodNagruzki.Open;
DBGrid1.Columns.Items[0].Title.Caption :='№ Преподавателей';
DBGrid1.Columns.Items[1].Title.Caption :='№ Групп';
DBGrid1.Columns.Items[2].Title.Caption :='№ Дисциплин';
DBGrid1.Columns.Items[3].Title.Caption :='Дата с';
DBGrid1.Columns.Items[4].Title.Caption :='Дата по';
end;
