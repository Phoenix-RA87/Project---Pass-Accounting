...
FDM.ADOQueryVvodGrupp.Open;
ShowMessage('Новая группа добавлена')
end;
...
FDM.ADOQueryVvodGrupp.Open;
DBGrid1.Columns.Items[0].Title.Caption :='№ Группы';
DBGrid1.Columns.Items[1].Title.Caption :='№ Специальности';
DBGrid1.Columns.Items[2].Title.Caption :='Курс';
DBGrid1.Columns.Items[3].Title.Caption :='Название группы';
DBGrid1.Columns.Items[4].Title.Caption :='ФИО Социального педагога';
end;
