...
FDM.ADOQueryVvodStud.Open;
ShowMessage('Новый студент добавлен')
end;
...
DBGrid1.Columns.Items[1].Title.Caption :='№ Группы';
DBGrid1.Columns.Items[2].Title.Caption :='ФИО Студента';
DBGrid1.Columns.Items[3].Title.Caption :='Дата выпуска';
end;
